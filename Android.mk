...
LOCAL_SHARED_LIBRARIES += codegen
LOCAL_LDLIBS += -llog
LOCAL_CFLAGS += -I'extern/libil2cpp/il2cpp/libil2cpp' -DID='"QustomMenuText"' -DVERSION='"0.3.2"' -I'./shared' -I'./extern' -isystem'extern/codegen/include'
